...
Monster In The Middle is a network analyzer in the early stages of development. Development is supported by [the ISC Project](https://iscproject.org).  This is currently not intended for public use. Application is intended for educational purposes only.
